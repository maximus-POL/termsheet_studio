...
3. Optionally enable the Microsoft 365 Copilot Selenium fallback.
...
- `fallback_copilot.py` uses Microsoft 365 Copilot via Selenium; model-provided values override regex values when present.
